...
const Layout = ({ children }) => {
  ...
  return (
    <>
      <header className="py-6">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between">
            <div className="md:w-1/2">TeeColorful.com – Wear Your Story, Paint Your Passion.</div>
            <div className="md:w-1/2 flex items-center justify-end space-x-3 -mr-2.5">
              <button
                ...
                <Link href="/">
                  <a className="flex items-center text-gray-900">
                    <div className="flex items-center justify-center mr-4">
                      <img src="/logo.png" alt="TeeColorful Logo" className="h-10"/>
                    </div>
                  </a>
                </Link>
                <Link href="/about">
      ...
      <footer className="max-w-6xl mx-auto px-6 flex items-center">
        <div className="md:w-1/3 border-t py-6">
          <h2 className="uppercase font-bold">teecolorful.com</h2>
          <p className="text-gray-600 text-sm">
            19749 DEARBORN ST CHATSWORTH, CALIFORNIA 91311<br/>
            Phone: +84 559 668 368<br/>
            Fax: +84 559 668 368<br/>
            Email: support@teecolorful.com
          </p>
        </div>
        <div className="md:w-1/3 border-t py-6">
          <p>News</p>
        </div>
        <div className="border-t py-6 text-center md:w-1/3">
          <nav className="justify-end space-x-3 md:space-x-6">
            <Link href="/about">
